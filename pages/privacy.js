  ...
  return (
    <div className="privacy-container">
      ...
      <div className="px-10 lg:px-20 py-12 text-justify">
        ...
        <p>
          enable us to provide the Services; ensure that content from our
          Website, Apps and Newsletters is presented in the most effective
          manner for you and for your device to achieve the most user-friendly
          navigation experience; provide you with marketing information about us
          and our services; notify you about changes to the Website, Apps and
          Newsletters and the Services; carry out our obligations arising out of
          the Terms of Use; and/or defend our servers against malicious attacks.
        </p>
        <h3>Cookies</h3>
        <p>
        ...
        <p>
          Google Analytics - To monitor our website performance and user
          experience
        </p>
        ...
        <p>
          ...
          not hesitate to contact us at support@topclient.com
        </p>
      </div>
    </div>
  );
